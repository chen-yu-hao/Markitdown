...
const api: MarkedownAPI = {
  ...
  detachDocument: (id, patch, editorState, position) => invoke('detachDocument', id, patch, editorState, position),
  completeDocumentTransfer: (id, accepted) => invoke('completeDocumentTransfer', id, accepted),
