...
await build({ entryPoints: ['src/renderer/diagram-runtime.ts'], bundle: true, platform: 'browser', target: 'chrome144', format: 'iife', minify: true, outfile: 'dist/main/diagram-runtime.js' });
