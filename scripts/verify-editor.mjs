...
try {
  ...
  console.log(JSON.stringify({ directory, checks: ['live widgets', 'source integrity', 'Unicode insertion', 'independent tab undo', 'mode history preservation', 'find/replace', 'tracked async image insertion', 'single image batch undo', 'Chromium Chinese IME composition', 'preference reconfiguration preserves source and history', 'native spellcheck attributes', 'smart typing punctuation', 'narrow viewport'], errors }));
} finally {
